...
- a: 'the beehive' is just the name we give to the website hosted at oreohive.org, and all content we host (usually via our web services) under the oreohive project for public availability.
  ...
  while our centre of our attention in these regards tends to be technology, homelab and development (what one could call 'computational creativity'), there areplenty of instances where we plan to spin off into other sectors and topics!
