...
<script lang="ts">
        ...
        export let panel_width: string = "180px"; // a string for panel's height
        ...
        export const img_width: string = "42px"; // a string for the picture's width
...
<div class="panel-container">
        ...
        <a
                {href}
                class="panel"
                style="box-shadow: 0px 0px 12px -2px {colour}; width: {panel_width}; background: {colour}; align-content: center;"
        >
                {#if img_url != ""}
                        <img
                                src={img_url}
